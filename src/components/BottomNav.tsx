...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white/95 dark:bg-gray-800/95 backdrop-blur-md border-t border-gray-200 dark:border-gray-700 shadow-[0_-1px_3px_rgba(0,0,0,0.05)] safe-area-inset-bottom z-30">
          ...
          >
            {({ isActive }) => (
              <>
                ...
                {isActive && (
                  <span className="absolute bottom-1 w-4 h-0.5 bg-primary-600 dark:bg-primary-400 rounded-full" />
                )}
              </>
            )}
          </NavLink>
